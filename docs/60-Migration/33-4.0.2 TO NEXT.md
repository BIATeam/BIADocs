...
4. Download the [migration script](./Scripts/V4.0.2_to_NEXT_Replacement.ps1) and the [standalone catch up script](./Scripts/standalone-catch-up.js) into the same directory
