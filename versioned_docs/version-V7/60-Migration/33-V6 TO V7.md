...
import V6ToV7ReplacementScript from './Scripts/V6_to_V7_Replacement.ps1?raw';
...
<CheckItem>Download the [migration script](./Scripts/V6_to_V7_Replacement.ps1) or copy the following content into a new script on your computer</CheckItem>
<CollapsibleCode fileContent={V6ToV7ReplacementScript} language="powershell" title="V6_to_V7_Replacement.ps1" maxLines={5} />
