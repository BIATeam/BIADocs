...
The usage of a dedicated table simplify the history of change in a user interface, and mandatory when displaying the historical of an entity ([see documentation](../20-DataLayer/20-CRUD/30-Historical.md)).
...
:::warning
Only compatible for entities with [configured audit linked entities](#configure-audit-linked-entities) and for usage of historical entity display ([see documentation](../20-DataLayer/20-CRUD/30-Historical.md)).
:::
