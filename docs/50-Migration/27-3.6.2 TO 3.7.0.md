...
5. Migration PrimeNg 13 :
   ...
   **If you use it (exept in bia template page = bia appear in path of the file) rename them.**
...
7. In initTableConfiguration function of the CRUD index
    1.  Add "isRequired: true" in BiaFieldConfig when field is required (information can be see in initForm() of yourfeature-table/yourfeature-table.component.ts with "Validators.required").
