...
## Configuration
:::warning
You must first implements dedicated audit for your CRUD entity : [see documentation](../../30-Security/80-Audit.md#dedicated-audit-table).
:::

:::tip
For projects from **BIAFramework V6** :
1. Enable audit onto your entity ([see documentation](../../30-Security/80-Audit.md#enable-entity-audit))
2. Use the BIAToolKit :
   1. Generate DTO with `Use dedicated audit` option enabled (as described into [Dedicated Audit Table documentation](../../30-Security/80-Audit.md#dedicated-audit-table))
