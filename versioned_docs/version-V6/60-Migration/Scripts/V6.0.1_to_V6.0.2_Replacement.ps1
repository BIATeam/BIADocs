...
# BACK END
# BEGIN - Column(nameof(IEntityVersioned.RowVersion)) -> BiaRowVersionProperty(DbProvider.SqlServer)
ReplaceInProject ` -Source $SourceBackEnd -OldRegexp '\[Column\(nameof\(IEntityVersioned\.RowVersion\)\)\]' -NewRegexp '[BiaRowVersionProperty(DbProvider.SqlServer)]' -Include "*.cs"
# END - Column(nameof(IEntityVersioned.RowVersion)) -> BiaRowVersionProperty(DbProvider.SqlServer)

# BEGIN - Column(nameof(IEntityVersioned.RowVersionXmin)) -> BiaRowVersionProperty(DbProvider.PostGreSql)
ReplaceInProject ` -Source $SourceBackEnd -OldRegexp '\[Column\(nameof\(IEntityVersioned\.RowVersionXmin\)\)\]' -NewRegexp '[BiaRowVersionProperty(DbProvider.PostGreSql)]' -Include "*.cs"
# END - Column(nameof(IEntityVersioned.RowVersionXmin)) -> BiaRowVersionProperty(DbProvider.PostGreSql)
